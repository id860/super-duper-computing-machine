...
const makeWorld = () => { const pixels = {}; for (let n = 0; n < 4000; n++) pixels[`${n % 1000}:${Math.floor(n / 1000)}`] = { c: '#000000' }; return { id: 'official', infinite: true, width: 1000, height: 1000, background: '#fff', access: { mode: 'public' }, members: {}, pixels }; };
